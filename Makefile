...
pkglibexecdir = $(libexecdir)/mjpegtools
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/mjpegtools.pc.in $(srcdir)/mjpegtools.spec.in \
...
CONFIG_CLEAN_FILES = mjpegtools.pc mjpegtools.spec
...
ACLOCAL = ${SHELL} /mjpegtools/missing --run aclocal-1.12
ALTIVEC_EXTRA_LIBS = 
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /mjpegtools/missing --run autoconf
AUTOHEADER = ${SHELL} /mjpegtools/missing --run autoheader
AUTOMAKE = ${SHELL} /mjpegtools/missing --run automake-1.12
AWK = mawk
CC = gcc
CCAS = gcc
...
CFLAGS = -march=core2 -mtune=core2 -g -O2 -pthread -Wall -Wunused
CPP = gcc -E
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -march=core2 -mtune=core2 -g -O2 -pthread 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LT_STATIC = 
MAINT = #
MAKEINFO = ${SHELL} /mjpegtools/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = mjpegtools 2.0.1
...
X_LIBS = 
X_PRE_LIBS = 
abs_builddir = /mjpegtools
abs_srcdir = /mjpegtools
abs_top_builddir = /mjpegtools
abs_top_srcdir = /mjpegtools
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /mjpegtools/install-sh
...
mjpegtools.pc: $(top_builddir)/config.status $(srcdir)/mjpegtools.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
mjpegtools.spec: $(top_builddir)/config.status $(srcdir)/mjpegtools.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
